  ...
  return (
    <div className="w-full bg-[#1e3a8a] py-16 px-6 flex flex-col items-center text-center">
      ...
      <div className="flex gap-4 mb-12">
        <button className="px-8 py-3 bg-white text-[#1e3a8a] text-sm font-bold rounded-lg shadow-lg hover:bg-gray-50 transition-colors">
          Open Digital Account
        </button>
        <button className="px-8 py-3 bg-[#1e293b] text-white text-sm font-bold rounded-lg shadow-lg hover:bg-[#0f172a] transition-colors border border-slate-700">
          Try Demo Account
        </button>
      </div>
